        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4  gap-4">
          {subCategories.map((model, i) => (
            <Link
              ...
              key={i}
              className="h-[100px] flex items-center justify-center border border-gray-600 rounded-xl py-3 text-center text-sm text-gray-300 hover:bg-gray-800 transition-all cursor-pointer"
            >
              {model.name}
            </Link>
          ))}
