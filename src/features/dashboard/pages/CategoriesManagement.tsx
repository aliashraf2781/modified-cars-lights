...
export default function CategoriesManagement() {
  ...
  const [editingItem, setEditingItem] = useState<Brand | subCategory | null>(
    null
  );
  ...
  const onSubCategorySubmit: SubmitHandler<SubCategoryFormInputs> = async (
    data
  ) => {
    ...
    <>
      ...
      <div className="p-6 bg-neutral-900 min-h-screen text-gray-100 space-y-8">
        <header className="flex justify-between items-center border-b border-neutral-800 pb-6">
          <div>
            ...
            <p className="text-gray-500 mt-1">
              Manage your main categories and their sub-categories
            </p>
          </div>
          <button
                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex gap-2  transition-opacity">
                      ...
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          handleDelete("category", cat.id.toString());
                        }}
        ...
        {selectedCategoryId && (
          <section className="animate-fade-in-up bg-neutral-900 rounded-xl border border-neutral-800 overflow-hidden">
            ...
            <div className="p-6">
              ...
              {subError && (
                <div className="text-red-400 py-2">Error: {subError}</div>
              )}
              ...
              {subCategories.length > 0 ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {subCategories.map((sub) => (
                    <div
                      key={sub.id}
                      className="flex items-center justify-between p-4 bg-linear-to-br from-neutral-800 to-black rounded-lg border border-neutral-800 hover:border-red-400 transition-colors group"
                    >
                      ...
                      <div className="flex gap-2  transition-opacity">
                        ...
                        <button
                          onClick={() =>
                            handleDelete("subcategory", sub.id.toString())
                          }
        ...
        >
          {modalType === "category" ? (
            <form
              onSubmit={handleSubmitCat(onCategorySubmit)}
              className="space-y-6"
            >
            ...
            <form
              onSubmit={handleSubmitSub(onSubCategorySubmit)}
              className="space-y-6"
            >
              <div className="grid grid-cols-2 gap-4">
                <div>
